            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post-thumb">
                        <img src="{{ 'post_img/'.$post->img }}" alt="seo">
                    </div>
                    ...
                    <div class="addthis_inline_share_toolbox_lzm2"></div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        ...
                        <img src="{{ asset('user_img/'.$post->user->profile->img) }}" alt="Author" width="100px" height="100px">
                        @else
                        <img src="{{ asset('user_img/profile.png') }}" alt="Author">  
                        @endif
                    </div>
